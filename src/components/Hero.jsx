...
export default function Hero() {
  return (
    <section className="relative min-h-[88vh] w-full overflow-hidden" aria-label="Hero">
      ...
      {/* Gradient + vignette overlays that don't block Spline interaction */}
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-white/70 via-white/20 to-white"></div>
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0)_0%,rgba(255,255,255,0)_40%,rgba(255,255,255,0.7)_100%)]"></div>

      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="max-w-3xl">
          <div className="inline-flex items-center rounded-full bg-white/80 px-3 py-1 text-xs font-medium text-gray-700 ring-1 ring-inset ring-gray-200 backdrop-blur">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            <a href="#performance" className="inline-flex items-center justify-center rounded-md bg-white/80 backdrop-blur px-5 py-3 text-sm font-medium ring-1 ring-gray-200 text-gray-900 hover:bg-white">
              View Performance
            </a>
          </div>
        </div>
